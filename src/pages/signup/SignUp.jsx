                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                                ...
                                <div className='flex gap-4'>
                                    ...
                                    <div className="form-control w-2/4">
                                        ...
                                        {errors.confirmPassword?.type === 'minLength' && <p className="text-red-600">Confirm Password must be 6 characters</p>}
                                        {errors.confirmPassword?.type === 'maxLength' && <p className="text-red-600">Confirm Password must be less than 20 characters</p>}
