...
const Banner = () => {
    return (
        <div className='relative bg-opacity-50'>
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-20 backdrop-filter"></div>
            <div>
            ...
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-x-4'>
                ...
                <button className=' py-4 uppercase mt-64 px-14 rounded-full bg-transparent text-xl border-2 text-white font-bold drop-shadow-xl shadow-xl'>View more</button>
