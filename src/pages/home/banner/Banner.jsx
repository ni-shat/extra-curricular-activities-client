    ...
    return (
        <div className='relative bg-opacity-50'>
            ...
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-x-4'>
                <button className='btn mt-64 px-14 rounded-full font-bold text-xl btn-lg text-[#C20909]'>Apply today</button>
                <button className='btn mt-64 px-14 rounded-full bg-transparent text-xl border-2 btn-lg text-white font-bold'>View more</button>
