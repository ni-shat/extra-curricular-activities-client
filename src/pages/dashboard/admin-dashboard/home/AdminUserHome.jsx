            ...
            <div className=' w-[70%]'>
                <div>
                    <div className=" bg-yellow-100  rounded-xl p-4 px-5 flex items-center justify-between shadow-2xl shadow-gray-300">
                        <div className='w-[60%]'>
                            <h2 className="mb-5 text-3xl font-bold">Hello Nishat!</h2>
                            <p>Welcome to admin dashboard. Your Central Hub for Managing and Monitoring the Platform.</p>
                        </div>
                ...
                <div className='bg-white rounded-xl p-4 shadow-2xl shadow-gray-300'>
                    ...
                    <div>
                        <div className='flex flex-col justify-center items-center gap-0.5 '>
                            ...
                            <p className='mb-2 font-semibold text-green-500'>Admin</p>
